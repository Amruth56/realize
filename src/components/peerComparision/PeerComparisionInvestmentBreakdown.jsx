...
const PeerComparisonInvestmentBreakdown = () => {
  return (
    <section className="grow px-6 pt-6 pb-24 w-full bg-white rounded-xl shadow-[0px_1px_2px_rgba(0,0,0,0.05)] max-md:px-5 max-md:mt-6 max-md:max-w-full">
      <h3 className="pt-1 pb-3 text-lg font-semibold text-black max-md:pr-5 max-md:max-w-full">
        Investment Breakdown
      </h3>
      <div className="mt-6 w-fullmax-md:max-w-full">
        <div className="flex flex-wrap gap-10 w-fullmax-md:max-w-full">
          <div className="flex flex-1 gap-4 py-1">
          ...
          <div className="flex flex-1 gap-5 py-1 my-auto text-sm leading-none">
        ...
        <div className="flex flex-wrap gap-5 justify-between mt-4 w-full max-md:max-w-full">
          ...
          <div className="flex gap-5 py-1 my-auto text-sm leading-none ">
        ...
        <div className="flex flex-wrap gap-10 mt-4 w-full max-md:max-w-full">
          <div className="flex flex-1 gap-3 py-1 ">
            <div className="flex overflow-hidden justify-center items-center self-start min-h-4">
              <img
