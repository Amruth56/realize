...
const PeerComparisonDashboardFooter = () => {
  return (
    <footer className="flex flex-col py-1 pr-6 pl-20 mt-5 w-full bg-white max-md:px-5 max-md:max-w-full">
      <div className="gap-3.5 self-end text-sm font-medium leading-none text-white w-[120px]">
        Integration Status
      </div>
      <div className="flex flex-col justify-center px-6 py-4 w-full max-w-screen-xl bg-black bg-opacity-0 max-md:px-5 max-md:max-w-full">
        <div className="flex flex-wrap gap-5 justify-between w-full bg-black bg-opacity-0 max-md:max-w-full">
          <p className="text-sm leading-none text-gray-600">
            Last updated: March 15, 2025
          </p>
          <button className="flex gap-2.5 px-1 py-0.5 bg-black bg-opacity-0">
