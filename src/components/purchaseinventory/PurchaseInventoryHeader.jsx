...
function PurchaseInventoryHeader() {
  return (
    <header className="flex flex-col justify-center px-16 py-px w-full bg-white border border-b max-md:px-5 max-md:max-w-full">
      <div className="flex flex-wrap gap-7 py-4 pl-5">
        <img
          ...
          alt="Company logo"
        />
        <div className="flex flex-wrap flex-auto gap-10 pl-20  max-md:max-w-full">
          <div className="flex gap-7 py-0.5 pl-9 my-auto ">
